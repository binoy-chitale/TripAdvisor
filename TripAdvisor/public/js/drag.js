$( function() {
  ...
  update : function(event,ui){  
    ...
    for (var i = 0; i < starttimes.length; i++) {
      ...
      var latitude1 = latitudes[i];
      var longitude1 = longitudes[i];
      if(i!=0){
      	var latitude2 = latitudes[i-1];
        var longitude2 = longitudes[i-1];
      }
      else{
        var latitude2=0;
        var longitude2=0;
      ...
      currentTime = updateTimes(currentTime,starttime,endtime,itemname,i, latitude1, longitude1, latitude2, longitude2);
	  }	
  }
});
...
function updateTimes(currentTime,starttime,endtime,itemname, i, latitude1, longitude1, longitude1, longitude2){
	if(currentTime===0){
        ...
        if(i!=0)
          ...
          var add=calculateTime(latitude1, longitude1, latitude2, longitude2);

  			currentTime = temp.addHours(add).toString("HH:mm");
  		}
  }
